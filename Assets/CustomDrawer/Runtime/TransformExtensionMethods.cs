...
public static class TransformExtensionMethods
{
	...
	public static void TranformLocalReset(this Transform transform)
    {
	...
	public static void TranformWorldReset(this Transform transform)
	{
		var mat = Matrix4x4.TRS(Vector3.zero, Quaternion.identity, Vector3.one).inverse;
